    ...
    return (
        <section id="home" className="min-h-screen flex flex-col justify-center px-8 md:px-20 bg-transparent">
            ...
            >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-center md:justify-start gap-8 border-t border-zinc-200 dark:border-zinc-800 pt-10">
                    ...
                    <div className="flex justify-center md:justify-start items-center gap-2 text-zinc-500 dark:text-zinc-400 text-sm font-medium">
